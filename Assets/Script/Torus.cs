...
public class Torus : MonoBehaviour {
	...
	public static float TORUS_R = 1f;
	public static float TORUS_r = 0.1f;
	public static int TORUS_Rn = 50;
	public static int TORUS_rn = 50;
	...
	void Update() {
		...
		//if the paramters have changed
		if(segmentRadius != TORUS_R || tubeRadius != TORUS_r || numSegments != TORUS_Rn || numTubes != TORUS_rn){
			RefreshTorus ();
		}

		segmentRadius = TORUS_R;
		tubeRadius = TORUS_r;
		numSegments = TORUS_Rn;
		numTubes = TORUS_rn;

		//Debug.Log ("R,r = " + TORUS_R + "," + TORUS_r);
